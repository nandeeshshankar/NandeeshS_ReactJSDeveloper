...
4. Open command prompt and navigate to NandeeshS_ReactJSDeveloper-main directory(where src dir is located).
5. Run "npm install" (that downloads dependency into your local machine)
6. Run "npm start" that kick off the application and opens the browser.
7. Enter any email and password, shows invalid error message in alert.
8. Enter valid username and password, shows athentication succesful message.
